...
return [
	...
	"color_images_is_required" => "Color images is required",
	"Upload_Size_Guide" => "Upload Size Guide",
	...
	"الامارات كل المناطق ماعدا المنطقة الغربية" => "الامارات كل المناطق ماعدا المنطقة الغربية",
	"successfully updated" => "Successfully updated",
	"new-messages.The_phone_number_must_be_at_least_4_characters" => "New-messages.The phone number must be at least 4 characters",
	" ) AND 1=1 UNION ALL SELECT 1 NULL script alert(XSS) /script table name FROM information schema.tables WHERE 2 1--/**/ EXEC xp cmdshell( cat ../../../etc/passwd )#" => " ) AND 1=1 UNION ALL SELECT 1 NULL   script alert(XSS) /script   table name FROM information schema.tables WHERE 2 1--/**/  EXEC xp cmdshell( cat ../../../etc/passwd )#",
