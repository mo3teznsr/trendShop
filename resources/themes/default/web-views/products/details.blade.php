                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100">
                                ...
                                <form id="add-to-cart-form" class="mb-2">
                                    ...
                                    <div>
                                        <div class="mt-3"> 
                                        <button type="button" class="btn px-0 text-primary btn-link" data-toggle="modal" data-target="#exampleModalCenter">
                                        {{ translate('size_guide') }}
                                        </button>
                                        ...
                                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">{{ translate('size_guide') }}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                   <img src='{{asset("storage/product/size_guide/$product->size_guide")}}'  style="width:100%" alt="" />
                                                </div>
