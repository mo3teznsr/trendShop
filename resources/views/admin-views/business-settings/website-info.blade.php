                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{ str_replace('app/public/','',dynamicAsset(path: 'public/assets/back-end/img/header-logo.png'))}}" alt="">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-logo" alt=""
                                     src="{{  str_replace('app/public/','',getStorageImages(path: $businessSetting['web_logo'] , type: 'backend-basic') )}}">
                            </div>
