...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ request('product-gallery')==1? route('admin.products.add') : route('admin.products.update',$product->id) }}" method="post"
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h3>{{ translate('size_guide') }}</h3>
                </div>
                <div class="card-body">
                <div class="size_guide_upload_input position-relative border-dashed-2">
                                                <input type="file" name="size_guide" class="size_guide_upload_input-file "
                                                       accept=".jpg, .webp, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*"
                                                       />
            ...
            @endif
            <input hidden name="existing_size_guide" value="{{$product->size_guide}}" />
        </form>
    </div>
